package com.caloshape.backend.foodlog.provider.routing;

import com.caloshape.backend.foodlog.provider.config.AiModelTiersProperties;
...
public class AiModelTierRouter {
    ...
    public AiModelTierRouter(AiModelTiersProperties props) {
