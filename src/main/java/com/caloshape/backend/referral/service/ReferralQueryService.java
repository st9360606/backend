...
import com.caloshape.backend.referral.dto.ReferralClaimItemDto;
...
public class ReferralQueryService {
    ...
    private Instant resolveReferralDeadline(com.caloshape.backend.referral.entity.ReferralClaimEntity claim) {
