...
-- Purpose:
-- 1. Track account deletion request lifecycle.
-- 2. Keep audit evidence that the user acknowledged subscription/free-trial warning.
-- 3. Preserve active entitlement snapshot at deletion request time
--    for billing, customer support, and Google Play review traceability.
-- ============================================================
...
(
    ...
    req_status                                     VARCHAR(16)  NOT NULL COMMENT 'REQUESTED/RUNNING/DONE/FAILED',
