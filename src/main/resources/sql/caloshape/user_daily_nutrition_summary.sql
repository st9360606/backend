...
-- Purpose:
-- 1. Store per-user daily nutrition summary by local date.
-- 2. Support Home dashboard, Progress charts, and daily macro overview.
-- 3. Store average health score calculated from valid food logs.
-- ============================================================

CREATE TABLE IF NOT EXISTS user_daily_nutrition_summary
(
    ...
    UNIQUE KEY uk_user_daily_nutrition_summary_user_date
        (user_id, local_date),

    INDEX idx_user_daily_nutrition_summary_date
        (local_date)
