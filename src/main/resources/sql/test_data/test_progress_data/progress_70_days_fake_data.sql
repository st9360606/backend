-- ============================================================
-- CaloShape / CaloShape ProgressScreen random 50 fake data in last 70 days
-- Target: MySQL 8.x
...
WITH ranked_days AS (
    SELECT
        ...
        ROW_NUMBER() OVER (
            ...
            ORDER BY CRC32(CONCAT(@user_id, ':', local_date, ':caloshape-progress-random-50-v1'))
            ) AS bucket_rank
