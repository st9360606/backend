-- ============================================================
-- CaloShape / CaloShape Subscription State Test SQL
-- user_id = 1
...
-- 3. product_id 使用 backend yml 內的 caloshape_monthly / caloshape_yearly。
