package com.caloshape.backend.foodlog.integration;
...
@Import({
        ...
        FoodLogProviderErrorMappingIT.TimeoutGeminiProviderConfig.class
})
public class FoodLogProviderErrorMappingIT {
