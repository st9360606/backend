// src/test/java/com/caloshape/backend/AutoAliasPromotionJobIT.java
package com.caloshape.backend.workout.job;
...
class AutoAliasPromotionJobIT {
    ...
    void should_promote_when_thresholds_met() {
        ...
        var opt = java.util.Optional.<com.caloshape.backend.workout.entity.WorkoutAlias>empty();
        for (int i = 0; i < 20; i++) {
