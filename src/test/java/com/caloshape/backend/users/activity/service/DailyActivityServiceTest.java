package com.caloshape.backend.users.activity.service;
...
import com.caloshape.backend.workout.service.UserDailyWorkoutSummaryService;
...
class DailyActivityServiceTest {
    ...
    void upsert_healthConnect_shouldComputeActiveKcal_fromLatestWeightAndSteps() {
        ...
        var weightEntity = mock(com.caloshape.backend.weight.entity.WeightTimeseries.class);
